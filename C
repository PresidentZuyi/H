...
MakeWindow({
  Hub = {
    Title = "President Zuyi | Gojo Style X Igaguri Style🔥🤑",
    Animation = "Made By ZuyiGoat🐐"
  },
  Key = {
    KeySystem = true,
    Title = "Exeuctive X Zuyi Custom Styles",
    Description = "^ President Zuyi Blue Lock Rivals ^",
    KeyLink = "https://discord.gg/tywV87Z3",
...
-- New Button for Igaguri Gurimu Style
AddButton(Main, { 
  Name = "Get Igaguri Gurimu Style", 
  Description = "Click to get Igaguri Gurimu Style", 
  Callback = function()
